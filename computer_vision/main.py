...
class MotionSensorShooter:
    ...
    def draw_crosshair_on_face(self, color=(0, 0, 255), thickness=2):
        ...
        face_radius = int(math.dist((nx, ny), (ear_x, ear_y)) * 1.5)
    ...
    def detect_motion(self):
        ...
        while cap.isOpened():
            ...
            self.processed_pose = self.pose.process(rgb_frame)
